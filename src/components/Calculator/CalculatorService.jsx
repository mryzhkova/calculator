...
class CalculatorService extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      culcValue: '',
  ...
  componentDidMount() {
    ...
    this.setState({
      showHistory: localStorage.getItem(storageKeys.showHistory) === null
        ? true
  ...
  handelClickButton = event => {
    ...
    if (currentValue && currentValue.includes('(')) {
      ...
      this.historyValue = `${culcValue.slice(
        0,
        culcValue.length - 1,
      )} ${last} `;
    }
